...
export default class ChgPWD extends Component {
    ...
    async SurePswBtn() {
        ...
        if (psw == "") {
            Toast.offline("所属银行不能为空!", 2);
            return;
        }
        if (twoPsw == "") {
            Toast.offline("银行卡号不能为空!", 2);
            return;
        }
                    ...
                    <div className={styles.inputList}>
                        <ul>
                            ...
                            <li>
                                ...
                                <div className={styles.inputwrap}>
                                    <input placeholder="请输入所属银行" onChange={this.changePsw.bind(this)} />
                                </div>
                            </li>
                            <li>
                                <div className={styles.iconWrap}>
                                ...
                                <div className={styles.inputwrap}>
                                    <input placeholder="请输入银行卡号" onChange={this.changeTwoPsw.bind(this)} />
                                </div>
                            </li>
