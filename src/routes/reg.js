...
export default class Reg extends Component {
    ...
    componentDidMount(){
        // //是否有参数
        // let cometel = this.props.location.search.replace("?cometel=", "") ?this.props.location.search.replace("?cometel=", ""):"";
                    ...
                    <div className={styles.mainList}>
                        <List className={styles.PlateBodyBList}>
                            <InputItem
                                ...
                                //defaultValue={this.state.cometel == "" ? "" : cometel}
                                
                                onChange={this.inputPtel.bind(this)}
                            >推荐人手机号
                            </InputItem>
                            <InputItem
                                className={styles.ListItem}
