...
export default class ChgPWD extends Component {
    ...
    async SurePswBtn() {
        ...
        let mobbile = this.state.mobbile;
    ...
    async onClickYzm() {
        ...
        //console.log(code)
        if (code===1){
            Toast.offline(code.message, 2);
        }else{
            Toast.fail(code.msg, 2);
            return ;
        }
                        ...
                        <ul>
                            <li>
                                ...
                                <div className={styles.inputwrap2}>
                                    <input placeholder="请输入手机号" disabled ref="mobbile" value={this.state.mobbile}/>
                                </div>
                            ...
                            <li>
                                ...
                                <div className={styles.inputwrap}>
                                    <input placeholder="请输入新的支付密码" onChange={this.changePsw.bind(this)} />
                                </div>
                            </li>
                            <li>
                                <div className={styles.iconWrap}>
                                ...
                                <div className={styles.inputwrap}>
                                    <input placeholder="请确认新的支付密码" onChange={this.changeTwoPsw.bind(this)} />
                                </div>
                            </li>
